...
namespace DXYK.Admin.Repository
{
    ...
    /// 收件人信息表
    ///</summary>
    public interface IOaMailReceiverRepository : IRepository<OaMailReceiver, long>
        , IRepositoryAsync<OaMailReceiver, long>
    {
        ///<summary>
        /// 新增
        ///</summary>
        ...
        new OaMailReceiver GetById([Param("id")]long id);
        ///<summary>
        /// 异步根据Id查询数据
        ///</summary>
        [Statement(Id = "GetEntity")]
        new Task<OaMailReceiver> GetByIdAsync([Param("id")]long id);
        ///<summary>
        /// 删除数据
        ///</summary>
        [Statement(Id = "Delete")]
