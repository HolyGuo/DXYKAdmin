...
namespace DXYK.Admin.Repository
{
    ///<summary>
        /// 角色授权功能表
        ///</summary>
    public interface ISysAppRoleMenuActionRepository : IRepository<SysAppRoleMenuAction, long>
        ,IRepositoryAsync<SysAppRoleMenuAction, long>
    {
...
[Statement(Id = "GetEntity")]
        new SysAppRoleMenuAction GetById([Param("id")]long id);
///<summary>
        /// 异步根据Id查询数据
        ///</summary>
[Statement(Id = "GetEntity")]
        new Task<SysAppRoleMenuAction> GetByIdAsync([Param("id")]long id);
///<summary>
        /// 删除数据
        ///</summary>
[Statement(Id = "Delete")]
