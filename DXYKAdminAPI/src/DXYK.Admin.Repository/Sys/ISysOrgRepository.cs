...
namespace DXYK.Admin.Repository
{
    ...
    /// 单位信息表
    ///</summary>
    public interface ISysOrgRepository : IRepository<SysOrg, string>
        , IRepositoryAsync<SysOrg, string>
    {
        ///<summary>
        /// 新增
        ///</summary>
        ...
        new SysOrg GetById([Param("id")]string id);
        ///<summary>
        /// 异步根据Id查询数据
        ///</summary>
        [Statement(Id = "GetEntity")]
        new Task<SysOrg> GetByIdAsync([Param("id")]string id);
        ///<summary>
        /// 删除数据
        ///</summary>
        [Statement(Id = "Delete")]
