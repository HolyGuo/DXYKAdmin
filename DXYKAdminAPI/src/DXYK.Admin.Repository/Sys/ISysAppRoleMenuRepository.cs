...
namespace DXYK.Admin.Repository
{
    ///<summary>
        /// 角色授权菜单表
        ///</summary>
    public interface ISysAppRoleMenuRepository : IRepository<SysAppRoleMenu, long>
        ,IRepositoryAsync<SysAppRoleMenu, long>
    {
...
[Statement(Id = "GetEntity")]
        new SysAppRoleMenu GetById([Param("id")]long id);
///<summary>
        /// 异步根据Id查询数据
        ///</summary>
[Statement(Id = "GetEntity")]
        new Task<SysAppRoleMenu> GetByIdAsync([Param("id")]long id);
///<summary>
        /// 删除数据
        ///</summary>
[Statement(Id = "Delete")]
